...
{
    public class PlanningAndApplicationController : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly string _apiBaseUrl;

        public PlanningAndApplicationController(IConfiguration configuration)
        {

            _configuration = configuration;
            _apiBaseUrl = _configuration.GetValue<string>("WebAPIBaseUrl");
        }
        public IActionResult PlanningAndApplicationCreate()
        {
            return View();
        }
        public IActionResult PlanningAndApplicationList()
        {
            return View();
        }
        public IActionResult PlanningAndApplicationEdit(int planningandapplicationid)
        {
            ViewBag.planningandapplicationid = planningandapplicationid;
            return View();
        }
